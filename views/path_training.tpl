...
% count = 0
% for path in path_global:
% count+=1

    <div class="carousel-item" data-interval="{{path_time}}" >
      <div style="background-color: black; height: 300px;" class="d-block w-100"></div>

        <div class="carousel-caption d-none d-sm-block">
          <h1 style='margin-top: -150px; font-size: 72px;'>{{path}}</h1>
          <p style='margin-top: -190px; color:grey;'>{{count}}/{{path_all}}</p>
        </div>
